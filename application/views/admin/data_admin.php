                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Management Data Admin UMPO</h2>
                                <hr>
                                <p class="card-text"> Jumlah admin yang terdaftar di Universitas Muhammadiyah Ponorogo sekarang adalah <span
                                        class="font-weight-bold" style="color:black;">
                                        <?php echo $this->db->count_all('admin'); ?> admin.</span> Untuk sementara, admin
                                    tidak dapat melakukan pendaftaran online sendiri. Hanya admin yang diperkenankan
                                    untuk mendaftarkan admin. </p>
                                <a href="<?=base_url('admin/add_admin')?>" class="btn btn-primary">Tambah
                                    Data admin</a>
                            </div>
                        </div>
                    </div>
    ...
    ?>
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo site_url('admin/update_admin/' . $a->id); ?>"
                                                    class="btn btn-info">Update</a>

                                                <a href="<?php echo site_url('admin/delete_admin/' . $a->id); ?>"
...
?>
                                ...
                                <p class="small font-weight-bold">Pendaftaran admin hanya dapat dilakukan admin.jika admin
    ...
    Swal.fire({
        icon: 'success',
        title: 'Data Admin Telah Dirubah!',
    ...
    <?php if ($this->session->flashdata('admin-delete')): ?>
    <script>
    Swal.fire({
        icon: 'success',
