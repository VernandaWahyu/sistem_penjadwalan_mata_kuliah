...
<head>
    ...
    <title>Tambah Data Admin - UMPO</title>
    <!-- General CSS Files -->
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tambah Data Admin</h2>
                                <hr>
                                <p class="card-text"> Silahkan isi data data yang diperlukan dibawah. Untuk sementara,
                                    Pendaftaran admin hanya dapat dilakukan oleh admin. Oleh karena itu, admin tidak dapat
