...
<head>
    ...
    <title>Tambah Data penjadwalan- UMPO</title>
    <!-- General CSS Files -->
...
?></div>
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tambah Data Penjadwalan</h2>
                                <hr>
                                <p class="card-text"> Silahkan isi data data yang diperlukan dibawah. Untuk sementara,
                                    Pendaftaran penjadwalan hanya dapat dilakukan oleh admin. Oleh karena itu, penjadwalan tidak dapat
                                    mendaftarkan dirinya sendiri tanpa izin admin
                                </p>
                    ...
                    <div id="detail" class="card card-success">
                        ...
                        <div class="card-body">
                        <form action="<?= base_url('admin/add_penjadwalan'); ?>" method="post">
    <div class="form-group">
        <label for="id_pengampu">Pengampu</label>
        <select id="id_pengampu" class="form-control" name="id_pengampu">
            <?php foreach ($pengampu as $p): ?>
                <option value="<?= $p->id_pengampu; ?>">
                    <?= $p->nama_dosen; ?> - <?= $p->kode_matakuliah; ?> - <?= $p->nama_kelas; ?>
                </option>
            <?php endforeach; ?>
        </select>
    ...
    <!-- The fields for id_ruang, hari, jam_mulai, and jam_selesai are removed
         since they will be automatically filled by the system. -->
