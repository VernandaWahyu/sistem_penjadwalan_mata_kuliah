...
<head>
    ...
    <title>Tambah Data kelas - UMPO</title>
    <!-- General CSS Files -->
            ...
            <div class="main-content">
                <section class="section">
                        ...
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <p class="card-text"> Silahkan isi data data yang diperlukan dibawah. Untuk sementara,
                                    Pendaftaran kelas hanya dapat dilakukan oleh admin. Oleh karena itu, kelas tidak dapat
                    ...
                    <div id="detail" class="card card-success">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?=base_url('admin/add_kelas')?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="jumlah_siswa" type="jumlah_siswa" class="form-control" name="jumlah_siswa">
