                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Management Data dosen UMPO</h2>
                                <hr>
                                <p class="card-text"> Jumlah dosen yang terdaftar di Universitas Muhammadiyah Ponorogo sekarang adalah <span
                                        class="font-weight-bold" style="color:black;">
                                        <?php echo $this->db->count_all('dosen'); ?> dosen.</span> Untuk sementara, dosen
                                    tidak dapat melakukan pendaftaran online sendiri. Hanya admin yang diperkenankan
                                    untuk mendaftarkan dosen. </p>
                                <a href="<?=base_url('admin/add_dosen')?>" class="btn btn-primary">Tambah
                                    Data dosen</a>
                            </div>
                        </div>
                    </div>
    ...
    ?>
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo site_url('admin/detail_dosen/' . $d->nik); ?>"
                                                    class="btn btn-success">Detail</a>
                                            </td>

                                            <td class="text-center">
                                                <a href="<?php echo site_url('admin/update_dosen/' . $d->nik); ?>"
                                                    class="btn btn-info">Update</a>

                                                <a href="<?php echo site_url('admin/delete_dosen/' . $d->nik); ?>"
...
?>
                                ...
                                <p class="small font-weight-bold">Pendaftaran dosen hanya dapat dilakukan admin.jika dosen
    ...
    <?php if ($this->session->flashdata('dosen-delete')): ?>
    <script>
    Swal.fire({
        icon: 'success',
