                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Management Data Kelas Penjadwalan Round Robin</h2>
                                <hr>
                                <p class="card-text"> Jumlah Kelas yang terdaftar sekarang adalah <span
                                        class="font-weight-bold" style="color:black;">
                                        <?php echo $this->db->count_all('kelas'); ?> Kelas.</span> Hanya admin yang diperkenankan
                                    untuk mendaftarkan Kelas. </p>
                                <a href="<?=base_url('admin/add_kelas')?>" class="btn btn-primary">Tambah
                                    Data Kelas</a>
                            </div>
                        </div>
                    </div>
    ...
    ?>
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo site_url('admin/update_kelas/' . $k->id_kelas); ?>"
                                                    class="btn btn-info">Update</a>

                                                <a href="<?php echo site_url('admin/delete_kelas/' . $k->id_kelas); ?>"
...
?>
                                ...
                                <p class="small font-weight-bold">Pendaftaran Kelas hanya dapat dilakukan admin.jika Kelas
    ...
    <?php if ($this->session->flashdata('kelas-delete')): ?>
    <script>
    Swal.fire({
        icon: 'success',
