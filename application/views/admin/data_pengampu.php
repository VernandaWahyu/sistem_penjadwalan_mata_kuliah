...
<head>
    ...
    <title>Data Pengampu - UMPO</title>
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Management Data pengampu Penjadwalan Round Robin</h2>
                                <hr>
                                <p class="card-text"> Jumlah pengampu yang terdaftar sekarang adalah <span
                                        class="font-weight-bold" style="color:black;">
                                        <?php echo $this->db->count_all('pengampu'); ?> pengampu.</span> Hanya admin yang diperkenankan
                                    untuk mendaftarkan pengampu. </p>
                                <a href="<?=base_url('admin/add_pengampu')?>" class="btn btn-primary">Tambah
                                    Data Pengampu</a>
                            </div>
                        </div>
                    </div>
...
foreach ($pengampu as $p) {
    ?>
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <?php echo $p->nama_dosen ?>
                                            </td>

                                            <td>
                                                <?php echo $p->kode_matakuliah ?>
                                            </td>

                                            <td>
                                                <?php echo $p->nama_kelas ?>
                                            </td>


                                            <td class="text-center">
                                                <a href="<?php echo site_url('admin/update_pengampu/' . $p->id_pengampu); ?>"
                                                    class="btn btn-info">Update</a>

                                                <a href="<?php echo site_url('admin/delete_pengampu/' . $p->id_pengampu); ?>"
...
?>
                                ...
                                <p class="small font-weight-bold">Pendaftaran Pengampu hanya dapat dilakukan admin.jika Pengampu
    ...
    Swal.fire({
        icon: 'success',
        title: 'Data pengampu Telah Dirubah!',
    ...
    <?php if ($this->session->flashdata('pengampu-delete')): ?>
    <script>
    Swal.fire({
        icon: 'success',
        title: 'Data Pengampu Telah Dihapus!',
