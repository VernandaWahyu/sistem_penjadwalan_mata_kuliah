...
<head>
    ...
    <title>Data Mata Kuliah - UMPO</title>
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Management Data Mata Kuliah Penjadwalan Round Robin</h2>
                                <hr>
                                <p class="card-text"> Jumlah matakuliah yang terdaftar sekarang adalah <span
                                        class="font-weight-bold" style="color:black;">
                                        <?php echo $this->db->count_all('mata_kuliah'); ?> matakuliah.</span> Untuk sementara, Mata Kuliah Hanya admin yang diperkenankan
                                    untuk mendaftarkan matakuliah. </p>
                                <a href="<?=base_url('admin/add_matakuliah')?>" class="btn btn-primary">Tambah
                                    Data MataKuliah</a>
                            </div>
                        </div>
                    </div>
...
foreach ($mata_kuliah as $mk) {
    ?>
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <?php echo $mk->nama_matakuliah ?>
                                            </td>
                                            
                                            <td>
                                                <?php echo $mk->kode_matakuliah ?>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo site_url('admin/update_matakuliah/' . $mk->id_matkul); ?>"
                                                    class="btn btn-info">Update</a>

                                                <a href="<?php echo site_url('admin/delete_matakuliah/' . $mk->id_matkul); ?>"
...
?>
                                ...
                                <p class="small font-weight-bold">Pendaftaran matakuliah hanya dapat dilakukan admin.jika matakuliah
    ...
    Swal.fire({
        icon: 'success',
        title: 'Data Mata Kuliah Telah Dirubah!',
    ...
    <?php if ($this->session->flashdata('matakuliah-delete')): ?>
    <script>
    Swal.fire({
        icon: 'success',
        title: 'Data Mata Kuliah Telah Dihapus!',
