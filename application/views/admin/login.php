...
<body>
    ...
    <a href="<?=base_url('welcome')?>"> 
        <img src="<?=base_url('assets/')?>/img/logo.jpeg" alt="logo" width="100" class="mb-5 mt-2">
    </a>
</div>

                        <h4 class="text-dark font-weight-normal">
                            <span class="font-weight-bold"> PENJADWALAN MATA KULIAH TEKNIK INFORMATIKA UMPO </span>
                        </h4>
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom"
                    data-background="<?=base_url('assets/')?>stisla-assets/img/unsplash/login-bg.jpeg">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            ...
                            Made with <span class="text-danger"> &#10084;</span> by <a class="text-light bb"
                                target="_blank" href="https://syauqizaidan.github.io/">Nawa_ZR</a> - Image by <a
