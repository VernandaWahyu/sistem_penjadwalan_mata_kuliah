...
<head>
    ...
    <title>Update Data Ruang - UMPO</title>
    <!-- General CSS Files -->
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Update Data Ruang</h2>
                                <hr>
                                <p class="card-text"> Update data ruang meliputi Nomor Ruang dan Kapasitas.
                                </p>
                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?=base_url('admin/ruang_edit')?>">

                            <div class="form-group">
                                    <label for="id_ruang">Id Ruang</label>
                                    <input readonly id="id_ruang" type="text" class="form-control" value="<?=$r->id_ruang?>"
                                        name="id_ruang">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="no_ruang" type="text" class="form-control" value="<?=$r->no_ruang?>"
                                        name="no_ruang">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="kapasitas" type="text" value="<?=$r->kapasitas?>" class="form-control"
                                        name="kapasitas">
