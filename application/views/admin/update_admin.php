...
<head>
    ...
    <title>Update Data Admin - UMPO</title>
    <!-- General CSS Files -->
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Update Data Admin</h2>
                                <hr>
                                <p class="card-text"> Update data siswa meliputi Email dan Username.
                                    Kita tidak bisa mengubah password admin, Hanya admin yang dapat mengubah passwordnya
                                    sendiri.
                                </p>
                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?=base_url('admin/admin_edit')?>">

                                <div class="form-group">
                                    <label for="id">ID</label>
                                    <input readonly id="id" type="text" class="form-control" value="<?=$a->id?>"
                                        name="id">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="email" type="email" value="<?=$a->email?>" class="form-control"
                                        name="email">
                                ...
                                <div class="form-group" id="detail">
                                    ...
                                    <input id="username" type="text" value="<?=$a->username?>" class="form-control"
                                        name="username">
                                ...
                                <div class="form-group" id="detail">
                                    ...
                                    <input id="password" type="password" value="<?=$a->password?>" class="form-control"
                                        name="password">
