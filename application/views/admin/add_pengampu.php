...
<head>
    ...
    <title>Tambah Data Pengampu - UMPO</title>
    <!-- General CSS Files -->
...
?></div>
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tambah Data Pengampu</h2>
                                <hr>
                                <p class="card-text"> Silahkan isi data data yang diperlukan dibawah. Untuk sementara,
                                    Pendaftaran pengampu hanya dapat dilakukan oleh admin. Oleh karena itu, pengampu tidak dapat
                    ...
                    <div id="detail" class="card card-success">
                        ...
                        <div class="card-body">
                        <form action="<?= base_url('admin/add_pengampu'); ?>" method="post">
    ...
    <div class="form-group">
        ...
        <select id="id_matkul" class="form-control" name="id_matkul">
            <?php foreach ($mata_kuliah as $mk): ?>
                <option value="<?= $mk->id_matkul; ?>"><?= $mk->nama_matakuliah; ?></option>
            <?php endforeach; ?>
        </select>
    ...
    <div class="form-group">
        ...
        <select id="id_kelas" class="form-control" name="id_kelas[]" multiple>
