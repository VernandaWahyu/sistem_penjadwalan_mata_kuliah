...
<head>
    ...
    <title>Tambah Data Mata Kuliah - UMPO</title>
    <!-- General CSS Files -->
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tambah Data Mata Kuliah</h2>
                                <hr>
                                <p class="card-text"> Silahkan isi data data yang diperlukan dibawah. Untuk sementara,
                                    Pendaftaran matakuliah hanya dapat dilakukan oleh admin.
                                </p>
                    ...
                    <div id="detail" class="card card-success">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?=base_url('admin/add_matakuliah')?>">
                                <div id="" class="form-group">
                                    <label for="nama_matakuliah">Nama Mata Kuliah</label>
                                    <input id="nama_matakuliah" type="text" class="form-control" name="nama_matakuliah">
                                ...
                                <div id="" class="form-group">
                                    ...
                                    <input id="kode_matakuliah" type="text" class="form-control" name="kode_matakuliah">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="SKS" type="text" class="form-control" name="SKS">
