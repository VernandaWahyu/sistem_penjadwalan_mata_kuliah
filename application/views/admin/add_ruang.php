...
<head>
    ...
    <title>Tambah Data Ruang - UMPO</title>
    <!-- General CSS Files -->
...
?></div>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Admin - UMPOy</div>
            ...
            <div class="main-content">
                <section class="section">
                        ...
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <p class="card-text"> Silahkan isi data data yang diperlukan dibawah. Untuk sementara,
                                    Pendaftaran ruang hanya dapat dilakukan oleh admin.
                                </p>
                    ...
                    <div id="detail" class="card card-success">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?=base_url('admin/add_ruang')?>">
                                <div id="" class="form-group">
                                    <label for="no_ruang">Nomor Ruang</label>
                                    <input id="no_ruang" type="text" class="form-control" name="no_ruang">
