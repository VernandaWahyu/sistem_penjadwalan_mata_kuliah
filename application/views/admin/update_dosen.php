...
<head>
    ...
    <title>Update Data dosen - UMPO</title>
    <!-- General CSS Files -->
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Update Data dosen</h2>
                                <hr>
                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?=base_url('admin/dosen_edit')?>">

                                <div class="form-group">
                                    <label for="nik">Nomor Induk Dosen</label>
                                    <input readonly id="nik" type="text" class="form-control" value="<?=$d->nik?>"
                                        name="nik">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="email" type="email" value="<?=$d->email?>" class="form-control"
                                        name="email">
                                ...
                                <div class="form-group" id="detail">
                                    ...
                                    <input id="nama" type="text" value="<?=$d->nama_dosen?>" class="form-control"
                                        name="nama">
