...
<head>
    ...
    <title>Update Data Mata Kuliah - UMPO</title>
    <!-- General CSS Files -->
                ...
                <section class="section">
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Update Data Mata Kuliah</h2>
                                <hr>
                                <p class="card-text"> Update data mata kuliah meliputi Nama Mata Kuliah dan SKS.
                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?=base_url('admin/matakuliah_edit')?>">

                            <div class="form-group">
                                    <label for="id_matkul">Id Mata Kuliah</label>
                                    <input readonly id="id_matkul" type="text" class="form-control" value="<?=$mk->id_matkul?>"
                                        name="id_matkul">
                                    ...
                                    <input  id="kode_matakuliah" type="text" class="form-control" value="<?=$mk->kode_matakuliah?>"
                                        name="kode_matakuliah">
                                    <?=form_error('kode_matakuliah', '<small class="text-danger">', '</small>');?>
                                    <div class="invalid-feedback">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input  id="nama_matakuliah" type="text" class="form-control" value="<?=$mk->nama_matakuliah?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="SKS" type="text" value="<?=$mk->SKS?>" class="form-control"
                                        name="SKS">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="semester" type="text" value="<?=$mk->semester?>" class="form-control"
                                        name="semester">
